...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, dx, dy):
        ...
        if tiles[self.pos_y + dy][self.pos_x + dx] and tiles[self.pos_y + dy][self.pos_x + dx] != "#":
...
print('Нажми на экран для начала работы...')
start_screen()

print('Привет, введи файл уровня (levelex3.txt, levelex2.txt, levelex1.txt):')
level = list(map(str.strip, sys.stdin))[0].strip()
